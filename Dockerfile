...
RUN apt-get update && \
apt-get install apache2 wget git-core curl locales locales-all openssl openssh-server nano cron apt-transport-https lsb-release ca-certificates pbzip2 libzip4 unzip ghostscript -y --allow-unauthenticated && \
